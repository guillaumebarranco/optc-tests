...
import { SaveTierListFrenchComponent } from './save-tier-list-french/save-tier-list-french.component';
...
export { TierListInformationsEnglishComponent } from './tier-list-informations-english/tier-list-informations-english.component';
export { SaveTierListFrenchComponent } from './save-tier-list-french/save-tier-list-french.component';
